<template>
<div class="wrapper">
    <h3 style="color:#009688">web-banner设定</h3>
    <div class="handle">
...
export default {
    ...
    methods:{
        getList(start){
            ...
            this.loading = true;
            this.$http('bannerService','findDatas',data)
            .then(res=>{
                console.log(res)
                this.loading = false;
                if(res.rows){
        ...
        suerBtn(){
            ...
            this.$http('bannerService','addOrUpdate',data)
            .then(res=>{
                this.propUpModel = false;
                this.id = "";
        ...
        deletes(id){
            this.$Modal.confirm({
                ...
                onOk: () => {
                     var data = {id:id};
                    this.$http('bannerService','deleteData',data)
                    .then(res=>{
                        if(res.result == 'success'){
